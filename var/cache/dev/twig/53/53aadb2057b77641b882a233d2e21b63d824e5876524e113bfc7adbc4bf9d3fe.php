...
class __TwigTemplate_5c3e13546399a38581fd8a8fdd5d476f46fd1449f18027b1911b7a1ce5328b52 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        <div class=\"col-12\">
            <a href=\"";
        // line 41
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("password_forgotten");
...
";
    ...
    {
        return array (  148 => 41,  129 => 25,  121 => 20,  116 => 17,  108 => 14,  105 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container\">
    <form method=\"post\">
        {% if error %}
            <div class=\"alert alert-danger my-5\">{{ error.messageKey|trans(error.messageData, 'security') }}</div>
        {% endif %}

        {% if app.user %}
            <div class=\"mb-3 my-5\">
                Tu es connecté sous {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Se déconnecter</a>
            </div>
        {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\laragon\\www\\Symfony\\agence\\templates\\security\\login.html.twig");
    }
}
