...
class __TwigTemplate_8a124dffffba48fe51bf2b2eaea1584e1c9b66cbf95847aa53fa67e472cd16aa extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
            // line 79
            $this->loadTemplate("shared/homeItem.html.twig", "main/index.html.twig", 79)->display(twig_array_merge($context, ["home" => $context["home"]]));
            // line 80
            echo "\t\t\t\t\t</div>
\t\t\t\t";
            ++$context['loop']['index0'];
...
\t";
    ...
    {
        return array (  259 => 100,  254 => 99,  244 => 98,  225 => 88,  219 => 85,  214 => 82,  199 => 80,  197 => 79,  194 => 78,  177 => 77,  173 => 75,  170 => 74,  167 => 73,  164 => 72,  162 => 71,  159 => 70,  157 => 69,  100 => 15,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"intro-heading text-uppercase\">Pour éviter les désagréments, faites confiance à notre agence !</div>
\t\t\t\t\t<a class=\"btn btn-primary btn-xl text-uppercase js-scroll-trigger\" href=\"{{ path('contact') }}\">Nous contacter</a>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
\t</header>
