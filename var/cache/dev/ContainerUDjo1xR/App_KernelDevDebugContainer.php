...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\PropertySearchController' => 'getPropertySearchControllerService',
    ...
    /**
     * Gets the public 'App\Controller\PropertySearchController' shared autowired service.
     *
     * @return \App\Controller\PropertySearchController
     */
    protected function getPropertySearchControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\PropertySearchController.php';

        $this->services['App\\Controller\\PropertySearchController'] = $instance = new \App\Controller\PropertySearchController(($this->privates['App\\Repository\\PropertySearchRepository'] ?? $this->getPropertySearchRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\PropertySearchController', $this));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\HomeRepository' => ['privates', 'App\\Repository\\HomeRepository', 'getHomeRepositoryService', false],
    ...
    /**
     * Gets the private '.errored..service_locator.0XGS6zp.Doctrine\ORM\Tools\Pagination\Paginator' shared service.
     *
     * @return \Doctrine\ORM\Tools\Pagination\Paginator
     */
    protected function getPaginatorService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\Tools\\Pagination\\Paginator.php';

        return $this->privates['.errored..service_locator.0XGS6zp.Doctrine\\ORM\\Tools\\Pagination\\Paginator'] = new \Doctrine\ORM\Tools\Pagination\Paginator();
    }

    /**
     * Gets the private '.service_locator.0XGS6zp' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_0XGS6zpService()
    {
        return $this->privates['.service_locator.0XGS6zp'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'paginator' => ['privates', '.errored..service_locator.0XGS6zp.Doctrine\\ORM\\Tools\\Pagination\\Paginator', NULL, 'Cannot autowire service ".service_locator.0XGS6zp": it references class "Doctrine\\ORM\\Tools\\Pagination\\Paginator" but no such service exists.'],
        ], [
    ...
    /**
     * Gets the private '.service_locator.Ymro4bQ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Ymro4bQService()
    {
        return $this->privates['.service_locator.Ymro4bQ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\PropertySearchController::index' => ['privates', '.service_locator.0XGS6zp', 'get_ServiceLocator_0XGS6zpService', false],
            ...
            'App\\Controller\\PropertySearchController::index' => '?',
    ...
    protected function getHomeRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\HomeRepository'] = new \App\Repository\HomeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.Ymro4bQ'] ?? $this->get_ServiceLocator_Ymro4bQService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\PropertyFixture(), 'groups' => []]]);
